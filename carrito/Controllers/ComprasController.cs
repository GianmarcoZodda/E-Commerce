...
namespace carrito.Controllers
{
    public class ComprasController : Controller
    {
        ...
        {
            var carritoContext = _context.Compras.Include(c => c.Carrito).Include(c => c.Cliente);
        ...
        public async Task<IActionResult> Create([Bind("Id,ClienteId,Total,CarritoId")] Compra compra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClienteId,Total,CarritoId")] Compra compra)
        {
            if (id != compra.Id)
            {
                return NotFound();
