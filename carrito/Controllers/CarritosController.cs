...
namespace carrito.Controllers
{
    public class CarritosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Activo,ClienteId,IdCompra,Subtotal")] Carrito carrito)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Activo,ClienteId,IdCompra,Subtotal")] Carrito carrito)
        {
            if (id != carrito.Id)
            {
                return NotFound();
