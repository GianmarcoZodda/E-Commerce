...
namespace carrito.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,PrecioVigente,Activo,CategoriaId,Imagen,StockItemId")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion,PrecioVigente,Activo,CategoriaId,Imagen,StockItemId")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
